      ...
      <CardContent className="p-2 sm:p-3 pt-0">
        <div className="grid grid-cols-1 gap-3">
          <div className="min-w-0">
            ...
            <p className="text-sm break-words">{empresa.nome}</p>
          </div>
          <div className="min-w-0">
            <p className="text-xs font-medium text-gray-600">Cliente</p>
            <p className="text-sm break-words">{empresa.cliente_nome || 'N/A'}</p>
          </div>
          <div className="min-w-0">
            <p className="text-xs font-medium text-gray-600">E-mail</p>
            <p className="text-sm break-words">{empresa.cliente_email || 'N/A'}</p>
          </div>
          <div className="min-w-0">
            <p className="text-xs font-medium text-gray-600">Telefone</p>
            <p className="text-sm break-words">{empresa.cliente_telefone || 'N/A'}</p>
          </div>
        </div>
      </CardContent>
    </Card>
