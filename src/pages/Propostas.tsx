  ...
  return (
    <div className="w-full min-h-screen overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-6 animate-fade-in">
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 w-full overflow-hidden">
          <div className="min-w-0 flex-1">
            <h1 className="text-xl lg:text-3xl font-bold text-gray-900 truncate">Propostas Comerciais</h1>
            <p className="text-gray-600 mt-1 text-sm lg:text-base truncate">Gerencie suas propostas baseadas nos diagnósticos</p>
          </div>
        ...
        <div className="space-y-6 w-full overflow-hidden">
          {filteredPropostas.map((proposta) => (
            <div key={proposta.id} className="w-full overflow-hidden">
              <ProposalCard
                proposta={proposta}
